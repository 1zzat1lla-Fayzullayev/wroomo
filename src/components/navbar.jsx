        ...
        <nav className="flex items-center justify-between">
          ...
          <div className="flex gap-3 items-center">
            <div className=" rounded-[5px] ">
              {isLoggedIn ? (
                <div className="flex gap-3 items-center">
                  <select className="outline-none hidden lg:block border border-[#262626] rounded-[5px] py-[8px] appearance-none px-2">
                    <option value="ru">RU</option>
                    <option value="en">EN</option>
                  </select>
                  <div className="min-h-[100%] w-[1.5px] h-[44px] bg-[#262626] hidden lg:block"></div>
                  <button className="px-[12px] py-[8px] border border-white rounded-[5px] hidden lg:block text-[14px]">
                    <strong>Сдать транспорт</strong>
                  </button>
                  <button className="border-none bg-white text-black px-[12px] py-[8px] rounded-[5px] text-[14px]">
                    Войти
                  </button>
                </div>
              ) : (
                <div className="flex gap-3 items-center">
                  ...
                  <div className="flex gap-3 px-[12px] py-[8px] cursor-pointer bg-[#262626] rounded-[5px]">
